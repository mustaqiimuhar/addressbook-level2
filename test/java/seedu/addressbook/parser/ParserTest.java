...
public class ParserTest {
    ...
    private static String convertPersonToAddCommandString(ReadOnlyPerson person) {
        String addCommand = "add "
                ...
                + (person.getPhone().isPrivate() ? " pp/" : " p/") + person.getPhone().get_value()
                + (person.getEmail().isPrivate() ? " pe/" : " e/") + person.getEmail().get_value()
                + (person.getAddress().isPrivate() ? " pa/" : " a/") + person.getAddress().get_value();
